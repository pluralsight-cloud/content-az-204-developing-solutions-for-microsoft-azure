...
class Program
    ...
    static async Task Main(string[] args)
        {   
            ...
            //Declare Container, called myContainer, on myDatabase, passing containerProps as a single parameter.
            Container myContainer = myDatabase.GetDatabase(containerProps);
            
            //Use the GenericItem class to create an item object, called myItem, to be upserted to the container.
            ...
            // Hint: The Main method is an async Task, so instantiate ItemReponse object to "kick off"
