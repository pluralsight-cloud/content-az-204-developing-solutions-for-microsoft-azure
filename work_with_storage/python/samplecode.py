...
class PythonBlobLab(object):
    ...
    my_connection_string = "DefaultEndpointsProtocol=https;AccountName=pythonlabp3qvp;AccountKey=ky2+jaGZvkQiM8PC6CuCyVLUs1aDon2i5vxSE9VtwgfRgNErexvYp0d88s7GezImqtd+fVIDv84h+ASteTUV6g==;EndpointSuffix=core.windows.net"
